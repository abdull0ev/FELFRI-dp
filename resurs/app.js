...
let opnerow = document.querySelector('.row__arrow')
let mobilrow = document.querySelector('.mobile__row')


opnerow.addEventListener('click', ()=>{
    opnerow.style.transform =' rotate(180deg)'
    mobilrow.style.display = 'block'
});
